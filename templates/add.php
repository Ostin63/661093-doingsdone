...
<form class="form" action="" method="post" enctype="multipart/form-data">
    <div class="form__row">
        ...
        <input class="form__input <?= $classname ?>" type="text" name="task[name]" id="name" value="<?= $value ?>"
    ...
    <div class="form__row">
        ...
        $value = isset($task['project']) ? (int) $task['project'] : 0 ?>
        <select class="form__input form__input--select" name="task[project]" id="project">
            <?php foreach ($projects as $project): ?>
                <option <?= (int) $project['id'] === $value ? 'selected' : '' ?>
    ...
    <div class="form__row">
        ...
        <input class="form__input form__input--date <?= $classname ?>" type="date" name="task[date]" id="date"
               value="<?= $value ?>" placeholder="Введите дату в формате ДД.ММ.ГГГГ">
