...
('Собеседование в IT компании', '2020-12-01', 0, 3),
('Выполнить тестовое задание', '2020-12-25', 0,  3),
('Сделать задание первого раздела', '2020-12-21', 1,  2),
('Встреча с другом', '2020-12-22', false,  1),
('Купить корм для кота', null, false,  4),
('Заказать пиццу', null, false,  4);

INSERT INTO tasks (name, date_completion, done, project_id) VALUES
('Собеседование в IT компании', '2020-12-10', 0, 8),
('Выполнить тестовое задание', '2020-12-26', 0,  8),
('Сделать задание первого раздела', '2020-12-21', 1,  7),
('Встреча с другом', '2020-12-23', false,  6),
('Купить корм для кота', '2020-12-24', false,  9),
('Заказать пиццу', null, false,  9);

INSERT INTO tasks (name, date_completion, done, project_id) VALUES
('Собеседование в IT компании', '2020-12-01', 0, 13),
('Выполнить тестовое задание', '2020-12-25', 0,  13),
('Сделать задание первого раздела', '2020-12-21', 1,  12),
('Встреча с другом', '2020-12-22', false,  11),
('Купить корм для кота', null, false,  14),
('Заказать пиццу', '2020-12-26', false,  14);
...
SELECT *  FROM tasks WHERE date_completion BETWEEN '2020-11-28' AND '2020-11-29'
